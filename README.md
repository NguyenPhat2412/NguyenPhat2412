...
My approach is not simply:

Build a feature → make it work → ship it

Instead:

Understand → Design → Implement → Test → Observe → Optimize → Scale
...
That means the public GitHub profile intentionally does not represent the complete scope of my engineering work.
...
🧭 Current Engineering Direction
       ...
       ▼                       ▼                       ▼
┌───────────────┐      ┌────────────────┐      ┌────────────────┐
│ SYSTEM DESIGN │      │ DISTRIBUTED    │      │ CLOUD / DEVOPS │
│               │      │ SYSTEMS        │      │                │
│ Architecture  │      │ Kafka          │      │ Docker         │
│ Scalability   │      │ WebSocket      │      │ CI/CD          │
│ Reliability   │      │ Events         │      │ Deployment     │
└───────────────┘      └────────────────┘      └────────────────┘
                               │
                               ▼
                     ┌──────────────────┐
...
⚡ Build · Measure · Scale · Improve

Engineering is not only about writing code.
It is about designing systems that continue to work when reality becomes complicated.

<br/>

<img src="https://komarev.com/ghpvc/?username=NguyenPhat2412&style=for-the-badge&color=00ff9c&label=PROFILE+VIEWS" alt="Profile views" />
